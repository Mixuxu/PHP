			...
			<article>
				...
				<fieldset>
					...
					<p>
						...
						<select name="sukupuoli" value="<?php print(htmlentities($ilmoitus->getSukupuoli(), ENT_QUOTES, "UTF-8"));?>">
					...
					<p>
						...
						<textarea name="viesti" form="ilmoitus" rows="5" cols="65" value="<?php print(htmlentities($ilmoitus->getViesti(), ENT_QUOTES, "UTF-8"));?>"></textarea>
